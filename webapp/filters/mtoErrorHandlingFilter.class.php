...
mtoClass :: import("mtokit/core/mtoErrorGuard.class.php");

class mtoErrorHandlingFilter implements mtoInterceptingFilter
{
    ...
    {
        $this->guard = new mtoErrorGuard();
        $this->toolkit = mtoToolkit :: instance();
    }

    function run($filter_chain)
    {
        $this->guard->registerErrorHandler(array($this, "handleError"));
        $this->guard->registerFatalErrorHandler(array($this, "handleFatalError"));
        $this->guard->registerExceptionHandler(array($this, "handleException"));
    ...
    {
        //die("Косячнег: быстро пойманный exception исключением не считается");
