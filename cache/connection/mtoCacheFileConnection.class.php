...
class mtoCacheFileConnection extends mtoCacheAbstractConnection
{
    ...
    function __construct($args)
    {
        ...
        $this->_cache_dir = $this->config['path'];
    ...
    function set($key, $value, $ttl = false)
    {
        ...
        lmbFs :: safeWrite($file, serialize($value));
    ...
    {
        return $this->getCacheDir() . '/' . $key . '.cache';
    }

    protected function _getCacheTtlFileName($key)
    {
        return $this->getCacheDir() . '/' . $key . '.ttl';
    }
